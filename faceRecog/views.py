...
#from faceRecog import settings
...
def create_dataset(request):
    ...
    record = Records(id=userId,first_name=first_name,last_name=last_name,country=country,education=education,occupation=occupation,bio=bio)
    record.save()
