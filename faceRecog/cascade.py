...
'''
def facecrop(image):
    facedata = r'C:\Users\maitr\AppData\Local\Temp\Temp1_facial-recognition-python-django-master.zip\facial-recognition-python-django-master\ml\haarcascade_frontalface_default.xml'
